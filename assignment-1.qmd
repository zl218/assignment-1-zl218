...
# Optimize
map_res = maximum_likelihood(model, Optim.NelderMead(), initial_params=[0.0, log(1.0), 0.0], maxiters=10_000) # Did not change the variable since this is a huge work so used the MLE as variable
